...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>{!!trans('admin/breadcrumb.link.edit')!!}</strong>
        </li>
    </ol>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/link/'.$link['encodeId'])}}" class="form-horizontal">
            {{csrf_field()}}
            {{method_field('PUT')}}
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name',$link['name'])}}" placeholder="{{trans('admin/link.model.name')}}">
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="url" value="{{old('url',$link['url'])}}" placeholder="{{trans('admin/link.model.url')}}">
                @if ($errors->has('url'))
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="description" value="{{old('description',$link['description'])}}" placeholder="{{trans('admin/link.model.description')}}">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
