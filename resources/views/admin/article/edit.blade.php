  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <form method="post" action="{{url('admin/article',[$article['id']])}}" class="form-horizontal" role="form" enctype="multipart/form-data">
          {{csrf_field()}}
          {{method_field('PUT')}}
                      ...
                      <div id="tab-1" class="tab-pane active">
                          <div class="panel-body">
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" value="{{old('title',$article['title'])}}" placeholder="{{trans('admin/article.model.title')}}">
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group{{ $errors->has('author') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control" name="author" value="{{old('author',$article['author'])}}" placeholder="{{trans('admin/article.model.author')}}">
                            ...
                            <div class="form-group{{ $errors->has('cid') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-10">
                                <select data-placeholder="Choose a category..." class="selectpicker form-control" name="cid[]" multiple="multiple">
                                  {!!$articlePresenter->categoryList($categories,$article['category'])!!}
                                </select>
                                @if ($errors->has('cid'))
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea class="layui-textarea" id="lead" name="lead" style="display: none">{!!old('lead',$article['lead'])!!}</textarea>
                              </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                  <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    <img src="{{$article['banner'] ? $article['banner']:asset('admin/img/no-image.png')}}">
                                  </div>
                            ...
                            <div class="form-group{{ $errors->has('tags') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-10">
                                <select data-placeholder="Choose a category..." class="selectpicker form-control" name="tags[]" multiple="multiple">
                                  {!!$articlePresenter->tagList($tags,$article['tag'])!!}
                                </select>
                                @if ($errors->has('tags'))
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <div class="i-checks">
                                  <label> <input type="checkbox" name="status" @if(old('status',$article['status'])) checked @endif value="1"></label>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div id="tab-2" class="tab-pane">
                        <div class="panel-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="meta_title" value="{{old('meta_title',$article['meta_title'])}}" placeholder="{{trans('admin/article.model.meta_title')}}">
                            </div>
                          </div>
                          <div class="hr-line-dashed"></div>
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="meta_keyword" value="{{old('meta_keyword',$article['meta_keyword'])}}" placeholder="{{trans('admin/article.model.meta_keyword')}}">
                            </div>
                          </div>
                          <div class="hr-line-dashed"></div>
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <textarea class="form-control" name="meta_description" placeholder="{{trans('admin/article.model.meta_description')}}">{{old('meta_description',$article['meta_description'])}}</textarea>
                            </div>
                          </div>
                        </div>
                      </div>
